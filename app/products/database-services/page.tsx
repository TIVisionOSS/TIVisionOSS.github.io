...
import { Database, Shield, Zap, Server, LineChart, Cloud } from "lucide-react"
import { motion } from "framer-motion"
import data from "@/data/products/database-services.json"
            ...
            >
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Real-time insights into database performance and usage patterns.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">✓ Performance metrics</li>
                    <li className="flex items-center">✓ Query analysis</li>
                    <li className="flex items-center">✓ Usage trends</li>
                  </ul>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">✓ Multi-cloud support</li>
                    <li className="flex items-center">✓ Hybrid deployments</li>
                    <li className="flex items-center">✓ Cloud migration tools</li>
                  </ul>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card>
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Database Types</h3>
                  <p className="text-muted-foreground mb-4">
                    Support for various database types and engines.
                  </p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center">✓ Relational databases</li>
                    <li className="flex items-center">✓ NoSQL databases</li>
                    <li className="flex items-center">✓ Time-series databases</li>
                  </ul>
                </CardContent>
              </Card>
            </motion.div>
